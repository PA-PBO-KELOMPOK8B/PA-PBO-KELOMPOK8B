...
public class CrudBarang extends javax.swing.JFrame {
    ...
    public CrudBarang() {
        ...
        // Tambahkan listener untuk menangkap event klik pada tabel
        tabel_crud_barang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabel_crud_barangMouseClicked(evt);
            }
        });
    }

    // Method untuk menangani event klik pada tabel
    private void tabel_crud_barangMouseClicked(java.awt.event.MouseEvent evt) {
        int row = tabel_crud_barang.getSelectedRow(); // Mendapatkan baris yang diklik

        // Mengisi kolom teks dengan data dari baris yang dipilih
        if (row != -1) {
            t_kodebarang.setText(model.getValueAt(row, 0).toString());
            t_nama.setText(model.getValueAt(row, 1).toString());
            t_stock.setText(model.getValueAt(row, 2).toString());
        }
    }
    ...
    private void loadData() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                Object[] row = {idBarang, nama, jumlah};
                model.addRow(row);
            }
