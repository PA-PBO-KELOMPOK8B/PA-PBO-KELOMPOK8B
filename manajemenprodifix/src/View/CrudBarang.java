...
public class CrudBarang extends javax.swing.JFrame {
    ...
    public CrudBarang() {
        ...
        tabel_crud_barang.setAutoCreateRowSorter(true); // Aktifkan sorting di header kolom

        barangController = new BarangController();
        barangController.loadData(model);
    }
    ...
    private void b_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_tambahActionPerformed
        ...
        try {
            ...
            if (barangController.isIdExist(idBarang)) {
                JOptionPane.showMessageDialog(this, "ID sudah ada!", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }

            // Tambah barang baru jika ID tidak ada
            barangController.insertBarang(idBarang, nama, stok);
    ...
    private void b_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_updateActionPerformed
        ...
        try {
            ...
            barangController.updateBarang(idBarang, nama, stok); // Panggil controller
            JOptionPane.showMessageDialog(this, "Data berhasil diperbarui!");
            barangController.loadData(model); // Refresh data via controller
            clearFields();
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Stok harus berupa angka!", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (SQLException e) {
    ...
    private void b_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_hapusActionPerformed
        ...
        try {
            barangController.deleteBarang(idBarang); // Panggil controller
