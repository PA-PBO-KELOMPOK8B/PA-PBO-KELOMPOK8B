...
import Controller.PinjamRuanganController;
...
public class PinjamRuangan extends javax.swing.JFrame {
    int xx, xy;
    private PinjamRuanganController controller;
    ...
    public PinjamRuangan() {
        initComponents();
        controller = new PinjamRuanganController();
        loadRoomData();

        // Mengaktifkan sorting pada tabel
        DefaultTableModel model = (DefaultTableModel) tabel_ruang.getModel();
        TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>(model);
        tabel_ruang.setRowSorter(sorter);
    }

    
    private void loadRoomData() {
        try {
            controller.populateTable((DefaultTableModel) tabel_ruang.getModel());
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(this, "Gagal memuat data ruangan: " + e.getMessage());
        }
    }


    private void ajukanPeminjaman() {
        String kodeRuangan = t_koderuang.getText();
        String tanggalPinjam = t_tanggal.getText();
        String jamPemakaian = t_jam.getText();
        String mahasiswaId = "MHS001"; // Dummy, ganti dengan ID login mahasiswa.

        try {
            controller.ajukanPeminjaman(kodeRuangan, tanggalPinjam, jamPemakaian, mahasiswaId);
            JOptionPane.showMessageDialog(this, "Peminjaman berhasil diajukan!");
            loadRoomData(); // Refresh tabel
        } catch (SQLException e) {
