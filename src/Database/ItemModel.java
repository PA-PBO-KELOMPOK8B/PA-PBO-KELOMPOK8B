...
public class ItemModel {
    private String idBarang;  // Sesuaikan tipe data dengan CHAR(10) di database
    private String nama;
    private int jumlah;       // Sesuaikan dengan tipe data INT di database
    private String peminjamanIdPeminjaman;  // Sesuaikan dengan CHAR(10) di database
