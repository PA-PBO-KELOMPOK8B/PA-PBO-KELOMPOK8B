...
public class RuangController {
    ...
    public void insertRuang(String idRuang, String nama, String status) throws SQLException {
        ...
        String defaultFasilitas = "AC, Whiteboard, TV"; // Default nilai fasilitas

        // Cek fasilitas berdasarkan ruangan lain di gedung yang sama
        ...
        // Masukkan data dengan fasilitas yang diperoleh atau default
